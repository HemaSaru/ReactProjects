    ...
    <>
      <div>
        <ul className="flex gap-10 mx-auto bg-black justify-center p-10">
          <li className="bg-teal-500 text-white py-2  px-6 rounded-md cursor-pointer hover:bg-teal-700" onClick={() => { ChangeTeam("CSK", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQE5UPWzjhMnFifbfE7M3dD2upyCwoN9g7FUmHLmMv79Q&s") }}>CSK</li>
